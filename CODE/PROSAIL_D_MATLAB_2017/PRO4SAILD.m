function [RES]=PRO4SAILD(lambdaref,N,Cab,Car,Ant,Cbrown,Cw,Cm,LIDFa,LIDFb,TypeLidf,lai,q,cc,tts,tto,psi,rs)

% This version is implemented by Richard Fernandes
% It is based on PRO4SAIL but fixes leaf reflectance and transmittance
% to sum to one and have a ratio same as given reference lambda
