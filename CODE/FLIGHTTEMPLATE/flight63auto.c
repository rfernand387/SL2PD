...
#define RESULT_ZEN_GRID 73   //MW: for bins of size N degrees:  RESULT_ZEN_GRID = (90/N)+1
#define RESULT_AZ_GRID 18    //MW: for bins of size N degrees:  RESULT_AZ_GRID = (360/N)
...
threed_light_incident_on_facet(stand_no,pos,ftype,facet_norm,vec_old,bounce_no,radsum0,radsum,radsum2,INSIDE_STAND)
	struct point *pos,*facet_norm,*vec_old;
